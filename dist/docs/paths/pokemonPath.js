...
const pokemonPath = {
  '/pokemon': {
    post: {
      ...
      responses: _responses.pokemonResponse.create
    }
  },
  '/pokemon/{id}': {
    get: {
      ...
      responses: _responses.pokemonResponse.get
    },
    delete: {
      tags: ['Pokemon'],
      ...
      responses: _responses.pokemonResponse.delete
    },
    patch: {
      tags: ['Pokemon'],
      ...
      responses: _responses.pokemonResponse.update
    }
  }
};
